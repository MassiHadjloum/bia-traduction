      ...
      <div className="pb-20 pt-10" id="hero">
        ...
        <div className="flex justify-center relative my-20 z-10">
          <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
            <h1 className="uppercase tracking-widest text-3xl text-center text-blue-100 max-w-80">
              {/* Bureau de Traduction – Ouaguenoun */}
              {t("title")}
            </h1>
            ...
            <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-xl">
              {/* Spécialisé dans la traduction de documents juridiques, académiques, 
