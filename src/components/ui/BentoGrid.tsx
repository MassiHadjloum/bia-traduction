...
export const BentoGridItem = ({
  ...
  const local = useLocale() as "en" | "fr" | "ar";
  ...
  return (
    ...
    >
      {/* add img divs */}
      <div className={`${id === 6 && "flex justify-center"}  ${local === "ar" && "text-right"}  h-full`}>
        ...
        >
          ...
          <div className="font-sans font-extralight md:max-w-32 max-w-[122px] md:text-xs lg:text-base text-sm text-[#C1C2D3] z-10">
            {description}
          </div>
